...
LOG_FOLDER=/home/ts678/nonproj/models/cdparser/mh4-local-s2s1s0b0/
...
MKL_NUM_THREADS=1 python -m acl18.cdparser \
    ...
    - train $TRAIN_FILE --dev $DEV_FILE \
        --utag True --xtag True --ast False --ahdp False --aedp False --mst False --npmst False --mh4 False --mh4t True --label True \
        --dev-portion 1.0 \
