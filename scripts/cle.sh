...
LOG_FOLDER=/home/ts678/nonproj/models/cdparser/cle/
...
MKL_NUM_THREADS=1 python -m acl18.cdparser \
    ...
    - train $TRAIN_FILE --dev $DEV_FILE \
        --utag True --xtag True --ast False --ahdp False --aedp False --mst False --npmst True --mh4 False --mh4t False --label True \
        --dev-portion 1.0 \
